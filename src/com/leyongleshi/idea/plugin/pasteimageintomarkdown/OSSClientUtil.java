...
public class OSSClientUtil {
     ...
     * 自定义域名
     */
    private static String ownName = "www.clhardstone.cn";
...
//            Date expiration = new Date((System.currentTimeMillis() + 1000*64800));
...
//            String newOwnName = url.getProtocol() + "://" + ownName + url.getFile() + url.getQuery();
//            System.out.println(newOwnName);
     ...
     * @return String 返回的唯一MD5数字签名
     */
    public static String uploadObject2OSSBufferImages(OSSClient ossClient, String bucketName, String folder, String fileName,Long fileSize,InputStream is) {
        String resultStr = null;
        try {
//            // 文件名
//            String fileName = file.getName();
